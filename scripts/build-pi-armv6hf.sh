...
cp $SYSROOT/lib/arm-linux-gnueabihf/libc-2.33.so $SYSROOT/lib/libc.so.6
cp $SYSROOT/lib/arm-linux-gnueabihf/libpthread-2.33.so $SYSROOT/lib/libpthread.so.0
