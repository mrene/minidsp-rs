...
mod test {
    ...
    fn test_parse() -> Result<()> {
        ...
        // PWR-ICE advertisement
        let d = Bytes::from_static(&[
            0x80, 0x12, 0x05, 0xa0, 0x00, 0x00, 0x00, 0x50, 0xc2, 0xd4, 0x37, 0x26, 0x00, 0x00,
            0xc0, 0xa8, 0xb2, 0x78, 0x00, 0x03, 0x00, 0x33, 0x00, 0xb6, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x5b, 0x00, 0x00, 0x00, 0x00, 0x10, 0x50, 0x57, 0x52, 0x2d, 0x49, 0x43,
            0x45, 0x32, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x00, 0xb8, 0x05, 0xd0, 0xf4,
            0x4d, 0xc2, 0xfa, 0xaf, 0x77, 0x7c, 0xdc, 0x0f, 0x96, 0xf4, 0xb4, 0xa5, 0x32, 0x34,
            0xe4, 0x87,
        ]);
        println!("d: {:?}", DiscoveryPacket::parse(&d));
        Ok(())
    }
}
